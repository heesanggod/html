...
console.log(funcLevel1);

// 블럭 레벨 변수는 해당 블럭 외부에서 사용 불가능
// {
//     let blockLevel1 = 10;
// }
// console.log(blockLevel1);
...
/*   
! 호이스팅 : var, funtion 선언문을 최상단에 선언한 것 처럼 동작하는 특성
...
/*
    ...
    - 객체에 할당하여 참조를 변경 하지 못하도록 하고 속성만 변경 가능 하도록 함
    - 일반적으로 객체는 상수로 사용
*/
const king = { name : '이성계' };

// TypeError: Assignment to constant variable. 재할당 하려고 한다.
// king = { name : '이방과' };
